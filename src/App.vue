<template>
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            <a class="navbar-brand logo-text" href="#">Videolity Vue Example</a>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Et blandit nisl libero at arcu. Donec ac lectus sed tellus mollis viverra. Nullam pharetra
                                ante at nunc elementum</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        ...
                        <p>Etiam tempus condimentum congue. In sit amet nisi eget massa condimentum lobortis eget ac eros.
                            In hac habitasse platea dictumst. Aenean molestie mauris eget sapien sagittis, a bibendum magna
                            tincidunt</p>
                    </div>
                </div>
            </div>
    ...
    <div class="footer bg-gray">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h4>If you want to find out which are the right influencers for your product marketing campaigns then
                        follow us</h4>
    ...
    <div class="copyright bg-gray">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <p class="p-small statement">Distributed by <a href="https://masukmia.com" target="_blank">Masuk Mia
                        </a></p>
                </div>
            </div>
        </div>
